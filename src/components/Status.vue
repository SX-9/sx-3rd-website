...
<template>
    <div class="card">
        ...
        <div class="p-2">
            ...
            <p v-if="user.data.discord_status === 'offline'" class="text-md text-gray-400"><i class="fa-solid fa-circle"></i> Offline</p>
            <p v-if="user.data.discord_status === 'online'" class="text-md text-green-400"><i class="fa-solid fa-circle"></i> Online</p>
            <p v-if="user.data.discord_status === 'dnd'" class="text-md text-red-400"><i class="fa-solid fa-circle"></i> Do Not Disturb</p>
            <p v-if="user.data.discord_status === 'idle'" class="text-md text-yellow-400"><i class="fa-solid fa-circle"></i> Idle</p>
            <div class="p-2 gap-3 flex flex-col">
                <div v-for="activity in user.data.activities.filter(a=>a.type===0)">
                    ...
                    <p class="text-md text-gray-400 pl-4">Started <span class="font-bold">{{ timeAgo(activity.timestamps.start) }}</span></p>
